<%-- 
    Document   : Sell
    Created on : Oct 25, 2018, 10:30:21 PM
    Author     : Malmi
--%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
        ...
        <br><br> <h3 align="center">Select Category</h3><br>
        <div class="row">
                   ...
                   <table border="0" align="center">
                       ...
                       <tbody>
                           ...
                           <tr>
                               <td></td>
                               <td>Organics</td>
                               <td><input type="radio" name="organic" value="organic" /></td>
                           </tr>
                           <tr>
                               <td></td>
                               <td>Metal</td>
                               <td><input type="radio" name="metal" value="metal" /></td>
                           </tr>
                           <tr>
                               <td></td>
                               <td>Plastic/Polythene</td>
                               <td> <input type="radio" name="plastic" value="plastic" /></td>
                           </tr>
                           <tr>
                               <td></td>
                               <td>Glass</td>
                               <td><input type="radio" name="glass" value="glass" /></td>
                           </tr>
                           <tr>
                               <td></td>
                               <td>Paper</td>
                               <td><input type="radio" name="paper" value="paper" /></td>
                           </tr>
                           <tr>
                               <td></td>
                               <td>Weight</td>
                         ...
                         <td></td>
                        <td>Start Date</td>
                        <td><input type="text" name="startdate" value="" size="2"/></td>
                    </tr>
                    <tr>
                         <td></td>
                        <td>End Date</td>
                        <td><input type="text" name="enddate" value="" size="2"/></td>
                    </tr>
                    <tr>
                         <td></td>
                        <td>Month</td>
                        <td><input type="text" name="mnth" value="" size="2" /></td>
                    </tr>
                    <tr>
                         <td></td>
                        <td>Year</td>
                        <td><input type="text" name="year" value="" size="4" /></td>
                    </tr>
                    <tr>
                               <td></td>
