<%-- 
    Document   : SellSuccessfuly
    Created on : Nov 11, 2018, 10:01:39 PM
    Author     : Malmi
--%>
...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="SellSuccessfuly.css">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
        ...
        <br><br>
        <h1 align="center">Sold Successfully!!!</h1>
